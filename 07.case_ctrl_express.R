...
library(tidyverse)
library(ggpubr)
output.dir <- paste0("/home/xingwl/practice5-Atherosis/noncoding/results-V24-Figure/public") 
~

## Fig2C Fig4C Fig5C ----
public <- readRDS("/home/pingxr/20240103_Atherosis/CONTROL/result/2-deg/4-all_merge_harmony/2_anno.rds")
