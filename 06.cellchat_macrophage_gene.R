...
p
ggsave(file.path(output.dir, "Fig6F_boxplot_NEAT1_CXCL8-CXCL3-CXCL2.pdf"),
       plot = p,
       height = 3,
       width = 3)
...
P <- expr %>%
  ...
  NoLegend()
P
ggsave(file.path(output.dir, "Fig6G_san_NEAT1_CXCL2.pdf"),
       plot = P,
       height = 2.5,
       width = 2.5)
#
P <- expr %>%
  ...
  NoLegend()
P
ggsave(file.path(output.dir, "Fig6G_san_NEAT1_CXCL3.pdf"),
       plot = P,
       height = 2.5,
       width = 2.5)
#
P <- expr %>%
  ...
  NoLegend()
P
ggsave(file.path(output.dir, "Fig6G_san_NEAT1_CXCL8.pdf"),
       plot = P,
       height = 2.5,
       width = 2.5)
...
P <- expr %>%
  ...
  NoLegend()
P
ggsave(file.path(output.dir, "FigS6F_san_NEAT1_chemotaxis.pdf"),
       plot = P,
       height = 2.5,
       width = 2.5)
...
ggsave(file.path(output.dir, "FigS6E_Voln_NEAT1_chemotaxis.pdf"),
       plot = p,
       height = 2.5,
       width = 2)
