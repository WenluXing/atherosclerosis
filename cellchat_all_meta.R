...
output.dir <- paste0("~/results-V24-Figure/Fig7/all_meta") 
...
groupSize <- as.numeric(table(cellchat@idents))
pdf(file.path(output.dir, "circle_number.pdf"),height=6,width=6)
netVisual_circle(cellchat@net$count, vertex.weight = groupSize, weight.scale = T, label.edge= F, title.name = "Number of interactions")
dev.off()
pdf(file.path(output.dir, "circle_weight.pdf"),height=6,width=6)
